          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative w-full max-w-md">
              ...
              <input
                ...
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full pl-9 pr-9 py-2 rounded-full border border-gray-200 bg-gray-50 text-sm text-gray-900 focus:outline-none focus:border-[#FF5533] focus:bg-white"
              />
              {/* Cross Icon */}
              {searchQuery && (
                <button
